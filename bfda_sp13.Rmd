...
BFDA based on ANOVA as in the original study and effect size from $\eta^2$
=======================================================================
...
```{r}
# Run simulations and save to disk (took ~Xh):
...
a) the effect size was either "medium" (i.e. 1.25 log-odds) or "small-to-medium"
(i.e., 0.9 log-odds); and
